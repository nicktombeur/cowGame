define(['angular','angularResource','ui-grid','jquery','angularRoute','routeResolver','pdfMake', 'app.route','app.ctrl','app.service','app.directive','cow/cowServices', 'cow/cowCtrl','angularMocks'], function() {
