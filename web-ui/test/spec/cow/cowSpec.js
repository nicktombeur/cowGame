define(['angular','jquery','materialize','angularRoute','routeResolver', 'app.route','app.ctrl','app.service','app.directive','cow/cowServices', 'cow/cowCtrl','angularMocks'], function() {
