define(['angular','../app.ctrl','jquery','cowGame','threejsCow'], function(angular,controllers,$) {
    controllers.controller('CowController', ['$scope','cowService',function($scope,cowService) {
